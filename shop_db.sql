...
(4, 'HR', 'Bach Da Hanh', 60, '1.jpeg', 'Higashino Keigo', 'NXB Hoi Nha Van', '2021', 'Vietnamese', 'Soft', 98, 'Osuke, the owner of a pawn shop, is murdered in an unfinished house and the one million yen he was carrying disappears. A month later, Fumiyo, who was rumored to have an affair with the victim, dies at home from gas poisoning and was suspected of killing Osuke to steal the money. With her death, the pawn shop murder case falls into a dead end. However, for two eleven-year-old children, the victims son and the suspects daughter, the case never truly ends. Growing up under the shadow of their parents deaths, Ryoji longs his entire life for the chance to walk under the sunlight, while Yukiho struggles endlessly, only to sink deeper into a never-ending white night.', 'Yes', '1'),
(5, 'ADV', 'Nui Chuot Quet', 50, '2.jpeg', 'Ho Dien Van', 'Hong Duc', '2022', 'English', 'Hard', 89, 'Ten years ago, the entire West District was terrified by a series of brutal murders targeting single women. The killer knocked his victims unconscious with a hammer, assaulted them, and destroyed evidence in extremely cruel ways. After following countless vague clues, the police were shocked to discover that the suspect was only a boy not yet eighteen years old. Ten years pass in apparent peace until one night a fire on Rat Sweep Mountain lights up the sky in deep red, and among the burned bodies this time are even children. The killer from the past has returned, silently confronting everyone and delivering his own judgment, forcing the investigation team to face the painful question of where the line between right and wrong truly lies.', 'Yes', '1'),(6, 'ADV', 'The Morningside', 26, '3.jpeg', 'Jenny Schwartz', 'Kindle Edition', '2017', 'English', 'Hard', 100, 'When starship shaman Jaya Romanov and her new mate partner, galactic bounty hunter and robot wolf shifter, Vulf Trent, saved the galaxy from the deadly actions of a determined geriatric terrorist, they forgot that old Earth truism: no good deed goes unpunished.', 'No', '1'),
